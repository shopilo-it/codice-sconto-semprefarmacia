 ...
 * Homepage: https://shopilo.it/negozi/semprefarmacia.it
 */

const SHOPILO_URL = "https://shopilo.it/negozi/semprefarmacia.it";
const STORE_NAME  = "SempreFarmacia";

async function fetchCoupons(url = SHOPILO_URL) {
  const res = await fetch(url, {
    headers: { "User-Agent": "coupon-fetcher/1.0 (+https://github.com/shopilo-it/codice-sconto-semprefarmacia)" }
  });
