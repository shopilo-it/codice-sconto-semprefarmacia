#!/usr/bin/env python3
"""
Recupero codici sconto SempreFarmacia da shopilo.it
Sursa: https://shopilo.it/negozi/semprefarmacia.it
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/semprefarmacia.it"
STORE_NAME = "SempreFarmacia"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per SempreFarmacia da shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-semprefarmacia)"
    }
    try:
